...
import com.mapper.PostFavourMapper;
import com.mapper.PostThumbMapper;
import com.model.entity.Post;
import com.model.entity.PostFavour;
import com.model.entity.PostThumb;
...
import com.model.dto.post.PostEsDTO;
    ...
    public Page<Post> searchFromEs(PostQueryRequest postQueryRequest) {
        ...
        if (CollectionUtils.isNotEmpty(orTagList)) {
            ...
            for (String tag : orTagList) {
                orTagBoolQueryBuilder.filter(QueryBuilders.termQuery("tags", tag));
            }
